...
\begin{table*} 
	...
	\lsptoprule
		...
		\{\isi{in-}\}  & 
				...
				{ \begin{tabular}[c]{@{}c@{}}\color{lsMidBlue} \textit{impossible}\\ (m\#C)\end{tabular}}         	\\\tablevspace
		\{\isi{dis-}\} & 
		...
		{ \begin{tabular}[c]{@{}c@{}}\color{lsMidBlue} \textit{probably}\\ (C\#l)\end{tabular}}\\\lspbottomrule
	\end{tabular}
\end{table*}
...
\begin{table} 
	...
	\resizebox{\textwidth}{!}{%
		...
		\\\tablevspace
			...
			{\begin{tabular}[c]{@{}c@{}}\color{lsMidBlue} \textit{immortal}\\ (m\#mV)\\ \color{lsMidBlue} \textit{innumerous}\\ (n\#nV)\end{tabular}} & NA                                                                            &
			 ...
			 {\begin{tabular}[c]{@{}c@{}}\color{lsMidBlue} \textit{mortal}\\ (\#mV)\\ \color{lsMidBlue} \textit{numerous}\\ (\#nV)\end{tabular}} \\\tablevspace
		...
		NA    	
			 & {\begin{tabular}[c]{@{}c@{}}\color{lsMidBlue} \textit{satisfy}\\ (\#sV)\end{tabular}}                   \\\tablevspace
	...
	NA    	         
			& {\begin{tabular}[c]{@{}c@{}}\color{lsMidBlue} \textit{real}\\ (Vl\#)\end{tabular}}\\\lspbottomrule
		\end{tabular}}
\end{table}
...
\todo[inline]{Please insert a introductory subsection, see the Generic Style Rules}
...
\subsection{The development of strict segmentation criteria}
...
\subsubsection{The nasals in \prefix{un} and \prefix{in}prefixed words}
...
\subsection{The fricative in \prefix{dis}prefixed words}
...
\subsubsection{The lateral in \suffix{ly}-suffixed words} \label{ly-segmentation}
...
\subsection{Segmenting a proportion of the data twice}
...
\subsection{Variables of interest} \label{variables of interest}\todo[inline]{subsections created here and in the rest of the Chapter}
...
The design of the ratings, as well as their outcomes, i.e. their distributions and the results of the reliability tests, will be discussed further in the pertinent chapters.\todo{Please be more specific}
