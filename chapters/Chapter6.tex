...
\begin{table}[H]
	...
	\begin{center}
		...
		%	\\
			...
			\hline
			n\#nV&\color[HTML]{3166FF}\textit{unnatural} & 6 & 23\\ 
			n\#C&\color[HTML]{3166FF}\textit{untold} & 53 & 68\\ 
			n\#V&\color[HTML]{3166FF}\textit{uneven} & 42 & 67\\
			\hline
			Total&  & 101 & 158\\ 
			\hline
		%	\hline
		...
		%	\\
			...
			Environment & Example & Number of Types & Number of Tokens\\
			\hline
			m\#mV&\color[HTML]{3166FF}\textit{immortal} & 16 & 89\\ 
			m\#C&\color[HTML]{3166FF}\textit{impossible} & 67 & 67\\ 
			\hline   
			Total&  & 83 & 156\\ 
			\hline     	
	%		\hline
		...
		%	\\
			...
			Environment & Example & Number of Types & Number of Tokens\\
			\hline
			s\#sV&\color[HTML]{3166FF}\textit{dissatisfied} & 9 & 24\\ 
			s\#C&\color[HTML]{3166FF}\textit{disgrace} & 21 & 45\\ 
			s\#V&\color[HTML]{3166FF}\textit{disarm} & 34 & 59\\ 
			\hline   	
			Total&  & 64 & 128\\ 
			\hline   	
	%		\hline
		...
		%	\\
			...
			Environment & Example & Number of Types & Number of Tokens\\
			\hline
			non-syllabic l\#l &\color[HTML]{3166FF}\textit{really} & 29  & 33 \\ 
			syllabic 	l\#l &\color[HTML]{3166FF}\textit{ment(a)lly} & 48 & 48 \\ 
			\#l &\color[HTML]{3166FF}\textit{possibly} & 73 & 73\\ 
			\hline   	
			Total&  & 150  & 154\\ 
		%	\hline   	
			\hline
...
\end{center}
 ...
 For \prefix{in} and \prefix{dis}, all variables showed enough variation to conduct cluster analyses. The results of the analyses for the two prefixes are displayed in the dendrograms in figure \ref{fig:cluster corpus dis and in}. 
...
With regard to the decomposability measures, only in the \prefix{in} and \prefix{dis}models all five decomposability variables were included. In the \prefix{un} and \suffix{ly}-models, only the effects of log\textsc{RelativeFrequency} and \textsc{LSAScore} were tested. The reason is the distribution of the variables in the different subsets (see section \ref {The decomposability of the four affixes: a comparison} for discussion). 
  ...
  \begin{table*}[t!]
  	...
  	\begin{center}
  		\begin{tabular} {lllll}
  			...
  			\hline			
  			n\#nV&\color[HTML]{3166FF}\textit{unnatural} & 100 & 102 & 21\\ 
  			n\#C&\color[HTML]{3166FF}\textit{untold} & 64 & 60 & 24\\ 
  			n\#V&\color[HTML]{3166FF}\textit{uneven} & 45 & 40 & 18\\
  			\hline   	
  			Overall &  & 60 & 54 & 28\\ 
  			\hline
  			%\hline
  			...
  			Environment & Example & Mean & Median& Standard Deviation\\
  			\hline			
  			m\#mV&\color[HTML]{3166FF}\textit{immortal} & 87 & 81 & 27\\   	
  			m\#C&\color[HTML]{3166FF}\textit{impossible} & 61 & 61 & 19\\ 
  			\hline   	
  			Overall &  & 76 & 74 & 27\\ 
  			\hline   
  			%\hline
  			...
  			Environment & Example & Mean & Median& Standard Deviation\\
  			\hline			
  			s\#sV&\color[HTML]{3166FF}\textit{dissatisfied} & 127 & 130  &35 \\ 
  			s\#C&\color[HTML]{3166FF}\textit{disgrace} & 100 & 100& 29\\ 
  			s\#V&\color[HTML]{3166FF}\textit{disarm} &95 & 96 & 22 \\ 
  			\hline   	
  			Overall &   &103   & 102  & 30  \\ 
  			\hline   	
  			%\hline
  			...
  			Environment & Example & Mean & Median& Standard Deviation\\
  			\hline			
  			l\#l&\color[HTML]{3166FF}\textit{really} & 50  & 50 & 23 \\ 
  			syllabic l\#l&\color[HTML]{3166FF}\textit{ment(a)lly} &41 & 37  & 21\\ 
  			\#l&\color[HTML]{3166FF}\textit{possibly} & 42& 39& 21\\ 
  			\hline   	
  			Overall &  &43  &41 &22\\ 
  			\hline   		
  		%	\hline
...
For \prefix{dis}, the comparison of the means also yields significant contrasts for the difference between doubles and singletons (see table \ref{tbl:Tukey dis}). However, the difference between the two singleton levels is not significant. None of the differences between the \suffix{ly}-environments proved to be significant. Thus, while for all the prefixes, doubles are significantly longer than singletons, this is not the case for the suffix \suffix{ly}.
...
Figure \ref{fig:SpeechRate un} depicts the effect of \textsc{LocalSpeechRate}.  The y-axis of the graph displays the duration of the nasal in milliseconds, the horizontal axis represents the local speech rate. The line represents the estimated effect of the variable. The shaded areas in the graphs represent the 95\% confidence intervals. The  plot shows, the higher the speech rate, i.e. the more segments are pronounced in a given amount of time, the shorter becomes the nasal. This is an expected effect.
...
An overview of the model coefficients is given in table \ref{tbl: summary model2}.% \pagebreak
...
Third, variables of decomposability  cannot be tested in an interesting way. This is because \prefix{un}, as described in section \ref{The decomposability of the four affixes: a comparison}, does not vary in most of the decomposability measures, and because relative frequency measures are not well comparable across \prefix{un} and \prefix{in}. The prefix \prefix{in} has very many bound roots, which is problematic with regard to computing relative frequency measures that are comparable to the relative frequency measures of affixes with hardly any or no bound roots, i.e. in this case \prefix{un}. 
...
\begin{table*}[h!]
	...
	\begin{center}
		...
		\begin{tabular}{lrrrr}
			...
			\textsc{BaseInitialStress}-\texttt{unstressed}  & \color[HTML]{9B9B9B}{0.017} & \color[HTML]{9B9B9B} 0.021 &\color[HTML]{9B9B9B}0.782  &\color[HTML]{9B9B9B} 0.436 \\ 
			\hline\\
...
%speech rate
Figure \ref{fig:corpus covariates dis} displays the effects of \textsc{LocalSpeechRate} and \textsc{Voicing}. The effect of \textsc{LocalSpeechRate} can be seen in the left panel. As expected, with increasing speech rate the fricative in \prefix{dis}prefixed words becomes shorter. 
%voicing
...
\begin{table*}[b!]
	...
	\begin{center}
		...
		\begin{tabular}{lrrrr}
			...
			\color[HTML]{9B9B9B}{-0.004 }& \color[HTML]{9B9B9B} 0.008 & \color[HTML]{9B9B9B}-0.523   &  \color[HTML]{9B9B9B}0.602  \\ 
...
With regard to decomposability, only the two decomposability measures \textsc{LSAScore} and log\textsc{RelativeFrequency} were tested in the model. As described in section \ref{The decomposability of the four affixes: a comparison}, in the \suffix{ly}-data set the variables \textsc{SemanticTransparency}, \textsc{TypeOfBase}  and \textsc{SemanticTransparencyRat-ing} did not show any, or barely any, variation. Therefore, their effect on consonant duration in \suffix{ly} could not be tested. The variable \textsc{PrecedingSegmentDuration} was also discarded. This was because of its high correlation with the variable \textsc{PrecedingSegment}, which would have caused collinearity problems in the model. In preliminary analyses, the variable \textsc{PrecedingSegment} proved to be the better predictor. Therefore, this variable was used in the model and not \textsc{PrecedingSegmentDuration}. 
...
\begin{table*}[h!]
	...
	\begin{center}
		...
		\begin{tabular}{lrrrr}
			...
			\color[HTML]{9B9B9B} {7.387}  & \color[HTML]{9B9B9B} 5.641 &\color[HTML]{9B9B9B}1.309 &\color[HTML]{9B9B9B} 0.192 \\
			\textsc{Environment}-\texttt{\#l} &
			\color[HTML]{9B9B9B} {3.965} & \color[HTML]{9B9B9B}  4.761 &\color[HTML]{9B9B9B}0.833  & \color[HTML]{9B9B9B}0.406 \\
