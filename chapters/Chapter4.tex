...
\figref{fig:Prosodic Hierarchy} shows the prosodic hierarchy, which depicts the different prosodic domains.\footnote{Note that the constituents of the hierarchy differ slightly depending on author and approach. The hierarchy displayed here is taken from \citet[9]{Hall.2001}.} 
...
\noindent	\textbf{A:\hspace{0.5cm}The decomposability of an individual word influences gemination} 
...
\noindent	\textbf{B: \hspace{0.5cm}The segmentability of an affix influences gemination} 
	
	
\noindent	The more segmentable an affix is, the higher is the degree of gemination with words containing that affix. 
...
\noindent 	\textbf{A:\hspace{0.5cm} Affix-specific informativeness influences gemination}
...
\noindent	\textbf{B: \hspace{0.5cm} Word-specific informativeness influences gemination}
