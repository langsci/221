...
%declare the tikzstyles
\tikzstyle{derivative} = [rectangle, rounded corners, minimum width=4cm, minimum height=2cm,text centered]
\tikzstyle{unnatural} = [circle, minimum width=3cm, minimum height=3cm,text centered, draw=black, line width= 0.05 cm]
\tikzstyle{natural} = [circle, minimum width=3cm, minimum height=3cm,text centered, draw=black, line width= 0.15 cm]
\tikzstyle{un} = [circle, minimum width=3cm, minimum height=3cm,text centered, draw=black]
